...
level2_from_em = SSHOperator(task_id="level2_from_em", ssh_conn_id="kd05_keydriver",
                             command="sh /usr/lib/quant/factor/factor_repo/tools/l2code/l2source_file/sync.sh ", dag=dag)
level2_to_kd = SSHOperator(task_id="level2_to_kd", ssh_conn_id="kd05_keydriver",
                           command="sh /usr/lib/quant/factor/factor_repo/tools/l2code/parser/parser.sh ", dag=dag)
